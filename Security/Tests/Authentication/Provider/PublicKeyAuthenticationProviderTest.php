...
class PublicKeyAuthenticationProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAuthenticate()
    {
        $provider = $this->getMock(
            PublicKeyAuthenticationProvider::class,
            ['readNonceValue', 'writeNonceValue'],
            [$this->userProvider, vfsStream::url('root').'/nonce/dir']
        );
        ...
        $this->userProvider->expects($this->any())->method('writeNonceValue');
